...
namespace game {
	...
	/// <summary>
	/// Summary for board8x8
	/// </summary>
	public ref class board8x8 : public System::Windows::Forms::Form
	{
	public:
		board8x8(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(board8x8::typeid));
			...
			this->label1->Click += gcnew System::EventHandler(this, &board8x8::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Location = System::Drawing::Point(46, 27);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(128, 41);
			this->label2->TabIndex = 65;
			this->label2->Text = L"player 2";
			this->label2->Click += gcnew System::EventHandler(this, &board8x8::label2_Click);
			// 
			// button65
			// 
			...
			this->button65->Location = System::Drawing::Point(1123, 763);
			this->button65->Name = L"button65";
			this->button65->Size = System::Drawing::Size(87, 52);
			this->button65->TabIndex = 66;
			this->button65->UseVisualStyleBackColor = false;
			this->button65->Click += gcnew System::EventHandler(this, &board8x8::button65_Click);
			// 
			// button66
			// 
			...
			this->button66->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button66->ForeColor = System::Drawing::Color::DarkBlue;
			this->button66->Location = System::Drawing::Point(32, 31);
			this->button66->Name = L"button66";
			this->button66->Size = System::Drawing::Size(112, 35);
			this->button66->TabIndex = 67;
			this->button66->Text = L"start";
			this->button66->UseVisualStyleBackColor = false;
			this->button66->Click += gcnew System::EventHandler(this, &board8x8::button66_Click);
			// 
			// label3
			// 
			...
			this->label5->Location = System::Drawing::Point(167, 58);
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &board8x8::timer1_Tick);
			// 
			// panel1
			// 
			...
			this->panel1->Size = System::Drawing::Size(705, 688);
			...
			this->panel5->Location = System::Drawing::Point(243, 1);
			...
			this->button64->Click += gcnew System::EventHandler(this, &board8x8::button64_Click);
			// 
			// button63
			// 
			...
			this->button63->Click += gcnew System::EventHandler(this, &board8x8::button63_Click);
			// 
			// button62
			// 
			...
			this->button62->Click += gcnew System::EventHandler(this, &board8x8::button62_Click);
			// 
			// button61
			// 
			...
			this->button61->Click += gcnew System::EventHandler(this, &board8x8::button61_Click);
			// 
			// button60
			// 
			...
			this->button60->Click += gcnew System::EventHandler(this, &board8x8::button60_Click);
			// 
			// button59
			// 
			...
			this->button59->Click += gcnew System::EventHandler(this, &board8x8::button59_Click);
			// 
			// button58
			// 
			...
			this->button58->Click += gcnew System::EventHandler(this, &board8x8::button58_Click);
			// 
			// button57
			// 
			...
			this->button57->Click += gcnew System::EventHandler(this, &board8x8::button57_Click);
			// 
			// button56
			// 
			...
			this->button56->Click += gcnew System::EventHandler(this, &board8x8::button56_Click);
			// 
			// button55
			// 
			...
			this->button55->Click += gcnew System::EventHandler(this, &board8x8::button55_Click);
			// 
			// button54
			// 
			...
			this->button54->Click += gcnew System::EventHandler(this, &board8x8::button54_Click);
			// 
			// button53
			// 
			...
			this->button53->Click += gcnew System::EventHandler(this, &board8x8::button53_Click);
			// 
			// button52
			// 
			...
			this->button52->Click += gcnew System::EventHandler(this, &board8x8::button52_Click);
			// 
			// button51
			// 
			...
			this->button51->Click += gcnew System::EventHandler(this, &board8x8::button51_Click);
			// 
			// button50
			// 
			...
			this->button50->Click += gcnew System::EventHandler(this, &board8x8::button50_Click);
			// 
			// button49
			// 
			...
			this->button49->Click += gcnew System::EventHandler(this, &board8x8::button49_Click);
			// 
			// button48
			// 
			...
			this->button48->Click += gcnew System::EventHandler(this, &board8x8::button48_Click);
			// 
			// button47
			// 
			...
			this->button47->Click += gcnew System::EventHandler(this, &board8x8::button47_Click);
			// 
			// button46
			// 
			...
			this->button46->Click += gcnew System::EventHandler(this, &board8x8::button46_Click);
			// 
			// button45
			// 
			...
			this->button45->Click += gcnew System::EventHandler(this, &board8x8::button45_Click);
			// 
			// button44
			// 
			...
			this->button44->Click += gcnew System::EventHandler(this, &board8x8::button44_Click);
			// 
			// button43
			// 
			...
			this->button43->Click += gcnew System::EventHandler(this, &board8x8::button43_Click);
			// 
			// button42
			// 
			...
			this->button42->Click += gcnew System::EventHandler(this, &board8x8::button42_Click);
			// 
			// button41
			// 
			...
			this->button41->Click += gcnew System::EventHandler(this, &board8x8::button41_Click);
			// 
			// button40
			// 
			...
			this->button40->Click += gcnew System::EventHandler(this, &board8x8::button40_Click);
			// 
			// button39
			// 
			...
			this->button39->Click += gcnew System::EventHandler(this, &board8x8::button39_Click);
			// 
			// button38
			// 
			...
			this->button38->Click += gcnew System::EventHandler(this, &board8x8::button38_Click);
			// 
			// button37
			// 
			...
			this->button37->Click += gcnew System::EventHandler(this, &board8x8::button37_Click);
			// 
			// button36
			// 
			...
			this->button36->Click += gcnew System::EventHandler(this, &board8x8::button36_Click);
			// 
			// button35
			// 
			...
			this->button35->Click += gcnew System::EventHandler(this, &board8x8::button35_Click);
			// 
			// button34
			// 
			...
			this->button34->Click += gcnew System::EventHandler(this, &board8x8::button34_Click);
			// 
			// button33
			// 
			...
			this->button33->Click += gcnew System::EventHandler(this, &board8x8::button33_Click);
			// 
			// button32
			// 
			...
			this->button32->Click += gcnew System::EventHandler(this, &board8x8::button32_Click);
			// 
			// button31
			// 
			...
			this->button31->Click += gcnew System::EventHandler(this, &board8x8::button31_Click);
			// 
			// button30
			// 
			...
			this->button30->Click += gcnew System::EventHandler(this, &board8x8::button30_Click);
			// 
			// button29
			// 
			...
			this->button29->Click += gcnew System::EventHandler(this, &board8x8::button29_Click);
			// 
			// button28
			// 
			...
			this->button28->Click += gcnew System::EventHandler(this, &board8x8::button28_Click);
			// 
			// button27
			// 
			...
			this->button27->Click += gcnew System::EventHandler(this, &board8x8::button27_Click);
			// 
			// button26
			// 
			...
			this->button26->Click += gcnew System::EventHandler(this, &board8x8::button26_Click);
			// 
			// button25
			// 
			...
			this->button25->Click += gcnew System::EventHandler(this, &board8x8::button25_Click);
			// 
			// button24
			// 
			...
			this->button24->Click += gcnew System::EventHandler(this, &board8x8::button24_Click);
			// 
			// button23
			// 
			...
			this->button23->Click += gcnew System::EventHandler(this, &board8x8::button23_Click);
			// 
			// button22
			// 
			...
			this->button22->Click += gcnew System::EventHandler(this, &board8x8::button22_Click);
			// 
			// button21
			// 
			...
			this->button21->Click += gcnew System::EventHandler(this, &board8x8::button21_Click);
			// 
			// button20
			// 
			...
			this->button20->Click += gcnew System::EventHandler(this, &board8x8::button20_Click);
			// 
			// button19
			// 
			...
			this->button19->Click += gcnew System::EventHandler(this, &board8x8::button19_Click);
			// 
			// button18
			// 
			...
			this->button18->Click += gcnew System::EventHandler(this, &board8x8::button18_Click);
			// 
			// button17
			// 
			...
			this->button17->Click += gcnew System::EventHandler(this, &board8x8::button17_Click);
			// 
			// button16
			// 
			...
			this->button16->Click += gcnew System::EventHandler(this, &board8x8::button16_Click);
			// 
			// button15
			// 
			...
			this->button15->Click += gcnew System::EventHandler(this, &board8x8::button15_Click);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &board8x8::button14_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &board8x8::button13_Click);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &board8x8::button12_Click);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &board8x8::button11_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &board8x8::button10_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &board8x8::button9_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &board8x8::button8_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &board8x8::button7_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &board8x8::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &board8x8::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &board8x8::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &board8x8::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &board8x8::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &board8x8::button1_Click);
			// 
			// panel2
			// 
			...
			this->panel2->Location = System::Drawing::Point(1011, 540);
			...
			this->panel3->Location = System::Drawing::Point(949, 26);
			...
			this->panel4->Location = System::Drawing::Point(3, 26);
			...
			this->panel6->Location = System::Drawing::Point(358, 706);
			...
			this->button67->Size = System::Drawing::Size(83, 64);
			this->button67->TabIndex = 150;
			this->button67->UseVisualStyleBackColor = false;
			this->button67->Click += gcnew System::EventHandler(this, &board8x8::button67_Click);
			// 
			// board8x8
			// 
			...
			this->Name = L"board8x8";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"board8x8";
			this->Load += gcnew System::EventHandler(this, &board8x8::board8x8_Load);
...
private: System::Void board8x8_Load(System::Object^ sender, System::EventArgs^ e) {
}
